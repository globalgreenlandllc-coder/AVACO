...
**Five types have their full official reports: Organizer, Catalyst, Performer, Analyst and Skeptic.** The other
three (Driver, Harmonizer, Mediator) show AVOCO's official description plus the short reading, with a note saying
the full report isn't added yet. To add one, give the
